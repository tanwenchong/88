#!/usr/bin/python
# -*- coding:utf-8 -*-
from math import cos, pi, log, exp,sin
import torch
from .abs_trainer import Trainer
#import transformers

class RNAmaskModelTrainer(Trainer):
    ...
    def get_scheduler(self, optimizer):
        ...
        optimizer, mode='min', factor=0.9, patience=20, min_lr=0.00001)
    ...
    def get_mask_ratio(self):
        ...
        ratio = 0.5 * (cos(step / self.max_step * pi * 0.5) )   # scale to [0, 0.3]
        return ratio
        
    def train_step(self, batch, batch_idx):
        #batch['mask_ratio'] = 0.3 #self.get_mask_ratio()
        #batch['mode'] = 'Train'
